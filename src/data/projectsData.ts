...
export const projectsData: Project[] = [
  {
    id: 'ruinxxi',
    title: 'Web Game #1 (ruinxxi.ru)',
    description: 'Полноценный веб-сервис с профилями, новостной лентой, чатом и друзьями. Реализован полный интерфейс и инфраструктура; основной игровой компонент пока в разработке. Сайт живёт на ruinxxi.ru и демонстрирует уровень полноценного продукта, а не лендинга.',
    features: [
      { text: 'Новостная лента с категориями и карточками статей' },
      { text: 'Чат: общий и групповые чаты, участники, история сообщений' },
      { text: 'Профили пользователей: «О себе», достижения, список друзей' },
      { text: 'Навигация, тёмная тема, уведомления' }
    ],
    technologies: [
      { name: 'React' },
      { name: 'TypeScript' },
    ...
    screenshots: [
      { src: '/Web-game/chat.png', alt: 'Чат — общий и групповые чаты' },
      { src: '/Web-game/Profile.png', alt: 'Профиль пользователя, достижения, друзья' }
    ],
    demoUrl: 'https://ruinxxi.ru/',
    thumbnail: '/Web-game/1-NEWs.png',
    badge: 'BEST'
  },
  {
    id: 'skyt',
