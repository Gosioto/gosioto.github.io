...
const newsData: NewsItem[] = [
  {
    date: '2025-01-28',
    version: 'v4.1',
    text: 'Добавлен новый проект в раздел «Проекты»: Web Game #1 (ruinxxi.ru) — полноценный сервис с новостной лентой, чатом и профилями. Обновлён визуал: кнопка Freelance рядом с приветствием на главной (в стиле страницы Freelance), систематизирован раздел «Навыки» (подкатегории и навигация), двусторонние ссылки между главной и Freelance.',
    importance: 'medium',
    category: 'update'
  },
  {
